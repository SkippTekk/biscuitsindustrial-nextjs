      ...
      <div className={style.links}>
        ...
        {session.status === "authenticated" ? (
          <div className={style.links}>
            ...
            <Link
              target="_blank"
              href={`https://login.eveonline.com/v2/oauth/authorize/?response_type=code&redirect_uri=http://localhost:3000/api/auth/eveonline/callback&client_id=788e7bb100fb40bcab58c81c5cdece42&scope=publicData esi-skills.read_skills.v1 esi-contracts.read_character_contracts.v1&state=${process.env.STATE}`}
