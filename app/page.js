  ...
  return (
    <div className={style.container}>
      <div className={style.item}>
        <h1 className={style.text}>Biscuits Industrial</h1>
        <p className={style.desc}>Eve Online, Spreadsheets in Space</p>
        <div className={style.leftText}>
          ...
          <p>
            ...
            in about six years or so) and I have forgotten it all. This is a
          ...
          any knowledge of HTML, PHP, and Java. Thanks to Mike for helping me
          get this started!
          <br />
          <br />
          <p>
            If you wish to help, you can help with pointers by mailing any of
            the toons left and right, or send isk to 'I like biscuits' on the
            right side. Donations are appreciated and let me know who is
            interested (it’s classified unless you tell me in the donation you
            want to be known).
          </p>
          <br />
          <p>
      ...
      <div className={style.img}>
        <Image
          ...
          height={400}
          alt="I like biscuits"
          style={{ border: "2px solid rgb(65, 245, 65)", borderRadius: "5px" }}
        />
      </div>
    </div>
  );
